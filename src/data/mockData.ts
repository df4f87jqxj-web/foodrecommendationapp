...
export const mockRestaurants: Restaurant[] = [
  ...
  },
  {
    ...
    priceLevel: '€',
    rating: 4.8,
    image: 'https://images.unsplash.com/photo-1594957647242-2b28c519d53c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxrZWJhcHxlbnwwfHx8fDE3NjEwMzUyMjZ8MA&ixlib=rb-4.1.0&q=80&w=1080',
    description: 'Der berühmteste Döner Berlins. Lange Schlange, aber das Warten lohnt sich für das frische Gemüse und die geheime Gewürzmischung.',
    address: 'Mehringdamm 32, 10961 Berlin',
    dietaryOptions: ['halal', 'vegetarian'],
    latitude: 52.4938,
    longitude: 13.3883,
    tags: ['Street Food', 'Legendary', 'Döner']
  },
  {
    id: '27',
    ...
    priceLevel: '€',
    rating: 4.6,
    image: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidXJnZXIlMjBzdHJlZXRmb29kfGVufDB8fHx8MTc2MTAzNTI4NHww&ixlib=rb-4.1.0&q=80&w=1080',
    description: 'Kult-Burger in einem ehemaligen Toilettenhäuschen unter der U-Bahn. Authentischer Berlin-Vibe.',
    address: 'Oberbaumstraße 8, 10997 Berlin',
    dietaryOptions: ['halal'],
    latitude: 52.5013,
    longitude: 13.4419,
    tags: ['Burger', 'Cult', 'Nightlife']
  },
  {
    id: '28',
    ...
    priceLevel: '€€',
    rating: 4.7,
    image: 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyYW1lbnxlbnwwfHx8fDE3NjEwMzUzMzh8MA&ixlib=rb-4.1.0&q=80&w=1080',
    description: 'Beste Tonkotsu Ramen der Stadt in cooler Atmosphäre direkt am Landwehrkanal.',
    address: 'Paul-Lincke-Ufer 39-40, 10999 Berlin',
    dietaryOptions: [],
    latitude: 52.4948,
    longitude: 13.4285,
    tags: ['Ramen', 'Cool', 'Japanese']
  },
  {
    id: '29',
    name: 'Katz Orange',
    ...
    priceLevel: '€€€',
    rating: 4.8,
    image: 'https://images.unsplash.com/photo-1514362545857-3bc16549766b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxkaW5uZXIlMjAlMjBmYW5jeXxlbnwwfHx8fDE3NjEwMzUzOTR8MA&ixlib=rb-4.1.0&q=80&w=1080',
    description: 'Slow Food in einem wunderschönen alten Brauerei-Gebäude. Perfekt für Dates und besondere Anlässe.',
    address: 'Bergstraße 22, 10115 Berlin',
    dietaryOptions: ['vegetarian', 'glutenfree'],
    latitude: 52.5317,
    longitude: 13.3989,
    tags: ['Fine Dining', 'Romantic', 'Slow Food']
  },
  {
    id: '30',
    ...
    priceLevel: '€',
    rating: 4.9,
    image: 'https://images.unsplash.com/photo-1585032226651-759b368d7246?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxub29kbGVzfGVufDB8fHx8MTc2MTAzNTQzNnww&ixlib=rb-4.1.0&q=80&w=1080',
    description: 'Die schärfsten und dicksten handgezogenen Nudeln Berlins. Biang Biang Noodles sind ein Muss!',
    address: 'Schönhauser Allee 65, 10437 Berlin',
    dietaryOptions: ['vegan', 'vegetarian'],
    latitude: 52.5418,
    longitude: 13.4121,
    tags: ['Spicy', 'Noodles', 'Trend']
  }
];
